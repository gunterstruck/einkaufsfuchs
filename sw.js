...
const CACHE = 'einkaufsfuchs-v0.12.0';
...
const SCHALE = [
    ...
    'favicon.ico?v=0.12.0',
    'icons/foxi.svg?v=0.12.0',
    'icons/favicon-64.png?v=0.12.0',
    'icons/icon-192.png?v=0.12.0',
    'icons/icon-512.png?v=0.12.0',
    'icons/maskable-512.png?v=0.12.0',
    'icons/apple-touch-icon.png?v=0.12.0'
];
