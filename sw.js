...
const CACHE = 'einkaufsfuchs-v0.8.2';
...
const SCHALE = [
    ...
    'favicon.ico?v=0.8.2',
    'icons/foxi.svg?v=0.8.2',
    'icons/favicon-64.png?v=0.8.2',
    'icons/icon-192.png?v=0.8.2',
    'icons/icon-512.png?v=0.8.2',
    'icons/maskable-512.png?v=0.8.2',
    'icons/apple-touch-icon.png?v=0.8.2'
];
